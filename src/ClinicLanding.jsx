...
const ClinicLanding = ({
  ...
  const services = {
    fr: [
      ...
      { title: "Empreinte Numérique", description: "Prise d'empreinte moderne et précise avec technologie numérique pour plus de confort.", image: "/images/services/Empreinte numerique.jpg" },
      { title: "Endodontie Mécanisée", description: "Traitement des canalicules dentaires avec instruments motorisés pour une meilleure efficacité.", image: "/images/services/Endodontie mécanisée.jpg" },
      ...
      { title: "Orthodontie Classique", description: "Correction de l'alignement et de l'occlusion dentaire avec des appareils orthodontiques.", image: "/images/services/Orthodontie.jpg" },
      ...
      { title: "Endodontie", description: "Traitement de la pulpe dentaire pour sauver vos dents naturelles.", image: "/images/services/endodontie.jpg" },
      { title: "Implantologie", description: "Pose d'implants dentaires pour remplacer les dents manquantes de manière durable.", image: "/images/services/implantologie.jpg" },
    ],
    ar: [
      ...
      { title: "الطبعات الرقمية", description: "أخذ طبعات سنية حديثة ودقيقة باستخدام التكنولوجيا الرقمية لراحة أكثر.", image: "/images/services/Empreinte numerique.jpg" },
      { title: "العلاج اللبي الميكانيكي", description: "معالجة قنوات الأسنان باستخدام أدوات كهربائية لفعالية أفضل.", image: "/images/services/Endodontie mécanisée.jpg" },
      ...
      { title: "طب أسنان الأطفال", description: "رعاية أسنان متخصصة للأطفال في بيئة آمنة وودية.", image: "/images/services/Pédodontie.jpg" },
      { title: "الأشعات السنية الرقمية", description: "أشعات سنية رقمية عالية الدقة مع تعرض إشعاعي أقل.", image: "/images/services/Radiologie intra-orale numérique (Rvg).jpg" },
      { title: "العلاج اللبي", description: "معالجة لب الأسنان لإنقاذ أسنانك الطبيعية.", image: "/images/services/endodontie.jpg" },
      { title: "زراعة الأسنان", description: "غرس أسنان صناعية لاستبدال الأسنان المفقودة بشكل دائم.", image: "/images/services/implantologie.jpg" },
