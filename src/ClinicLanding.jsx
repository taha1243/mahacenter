...
/**
 * ClinicLanding — Single-file React template (TailwindCSS classes left in place)
...
const ClinicLanding = ({
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"} className="clinic-root min-h-screen bg-gray-50 text-gray-900">
      {/* Header */}
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="logo-cluster flex items-center gap-3">
            <img src={clinicLogo} alt={clinicName} className="site-logo" />
      ...
      >
        <div className={`bg-gradient-to-b ${coverUrl ? "from-black/30 to-white" : ""}`}>
          <div className="max-w-6xl mx-auto px-4 py-16">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight">{clinicName}</h1>
            ...
            <div className={`mt-6 flex ${isRTL ? "flex-row-reverse" : ""} gap-3`}>
              <button
                ...
                className="cta ghost px-4 py-2 rounded-xl border border-gray-300 bg-white hover:bg-gray-100 shadow-sm"
              >
                {t.viewSchedule}
              </button>
              <button
                onClick={onReserve}
                className="cta solid px-4 py-2 rounded-xl bg-black text-white hover:bg-gray-800 shadow"
              >
                {t.reserve}
              </button>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="doctor-grid mt-6 grid grid-cols-1 md:grid-cols-[220px_1fr] gap-6 items-start">
          <div className="w-full">
            <div className="avatar aspect-square rounded-2xl bg-gray-200 overflow-hidden">
              {doctorAvatarUrl ? (
          ...
          <div className="card bg-white rounded-2xl shadow p-6">
            ...
            <p className="mt-4 leading-relaxed text-gray-700">{lang === "fr" ? doctorBioFR : doctorBioAR}</p>
            <div className="info-grid mt-6 grid sm:grid-cols-2 gap-4 text-sm">
              <div className="info-box bg-gray-50 rounded-xl p-4">
