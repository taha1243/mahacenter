...
const ClinicLanding = ({
  ...
  const services = {
    fr: [
      ...
      { title: "Blanchiment Dentaire Professionnel", description: "Blanchissement des dents avec produits professionnels pour un sourire plus blanc et éclatant.", image: "/images/services/Blanchiment dentaire professionnel.jpg" },
      { title: "Détartrage", description: "Elimination du tartre et des dépôts dentaires avec des techniques ultrasoniques pour une hygiène optimale.", image: "/images/services/Détartrage.jpg" },
      { title: "Empreinte Numérique", description: "Prise d'empreinte moderne et précise avec technologie numérique pour plus de confort et de précision.", image: "/images/services/Empreinte numerique.jpg" },
      { title: "Endodontie Mécanisée", description: "Traitement des canalicules dentaires avec instruments motorisés pour une meilleure efficacité et précision.", image: "/images/services/Endodontie mécanisée.jpg" },
      { title: "Extraction Dentaire", description: "Extraction dentaire sûre et douce avec techniques modernes et gestion de la douleur.", image: "/images/services/Extraction dentaire.jpg" },
      { title: "Orthodontie par Aligneurs", description: "Correction de l'alignement dentaire avec des gouttières invisibles et confortables.", image: "/images/services/Orthodontie par aligneurs ( gouttieres invisibles).jpg" },
      { title: "Orthodontie Classique", description: "Correction de l'alignement et de l'occlusion dentaire avec des appareils orthodontiques modernes.", image: "/images/services/Orthodontie.jpg" },
      { title: "Pédodontie", description: "Soins dentaires spécialisés pour enfants dans un environnement bienveillant et rassurant.", image: "/images/services/Pédodontie.jpg" },
      { title: "Radiologie Intra-orale Numérique", description: "Radiographies dentaires numériques haute résolution avec exposition minimale aux radiations.", image: "/images/services/Radiologie intra-orale numérique (Rvg).jpg" },
      { title: "Endodontie", description: "Traitement de la pulpe dentaire pour sauver vos dents naturelles et éviter l'extraction.", image: "/images/services/endodontie.jpg" },
      { title: "Implantologie", description: "Pose d'implants dentaires pour remplacer les dents manquantes de manière durable et esthétique.", image: "/images/services/implantologie.jpg" },
    ],
    ar: [
      ...
      { title: "تبييض الأسنان الاحترافي", description: "تبييض الأسنان باستخدام منتجات احترافية للحصول على ابتسامة أكثر بياضاً وإشراقاً.", image: "/images/services/Blanchiment dentaire professionnel.jpg" },
      { title: "إزالة الجير", description: "إزالة الجير والترسبات السنية باستخدام تقنيات فوق صوتية للحفاظ على صحة الفم المثلى.", image: "/images/services/Détartrage.jpg" },
      { title: "الطبعات الرقمية", description: "أخذ طبعات سنية حديثة ودقيقة باستخدام التكنولوجيا الرقمية لراحة ودقة أكثر.", image: "/images/services/Empreinte numerique.jpg" },
      { title: "العلاج اللبي الميكانيكي", description: "معالجة قنوات الأسنان باستخدام أدوات كهربائية لفعالية وتدقيق أفضل.", image: "/images/services/Endodontie mécanisée.jpg" },
      { title: "خلع الأسنان", description: "خلع آمن ولطيف للأسنان باستخدام تقنيات حديثة وإدارة الألم.", image: "/images/services/Extraction dentaire.jpg" },
      { title: "تقويم الأسنان بالمحاذي", description: "تصحيح محاذاة الأسنان باستخدام قوالب شفافة غير مرئية ومريحة.", image: "/images/services/Orthodontie par aligneurs ( gouttieres invisibles).jpg" },
      { title: "تقويم الأسنان الكلاسيكي", description: "تصحيح محاذاة والعضة السنية باستخدام أجهزة تقويم حديثة.", image: "/images/services/Orthodontie.jpg" },
      { title: "طب أسنان الأطفال", description: "رعاية أسنان متخصصة للأطفال في بيئة آمنة وودية وآمنة.", image: "/images/services/Pédodontie.jpg" },
      { title: "الأشعات السنية الرقمية", description: "أشعات سنية رقمية عالية الدقة مع تعرض إشعاعي أقل للسلامة.", image: "/images/services/Radiologie intra-orale numérique (Rvg).jpg" },
      { title: "العلاج اللبي", description: "معالجة لب الأسنان لإنقاذ أسنانك الطبيعية وتجنب الخلع.", image: "/images/services/endodontie.jpg" },
      { title: "زراعة الأسنان", description: "غرس أسنان صناعية لاستبدال الأسنان المفقودة بشكل دائم وجمالي.", image: "/images/services/implantologie.jpg" },
    ],
  };
